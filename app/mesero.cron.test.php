...
/*
if (file_exists('../../../includes/MyDBi.old.php')) {
  require_once '../../../includes/MyDBi.old.php';
  //require_once '../../../includes/utils.php';
} else {
  require_once 'MyDBi.old.php';
}
*/
require_once 'includes/MyDBi.old.php';
...
//echo("<div>".$fecha_desde."</div>");
//echo("<div>".$fecha_hasta."</div>");
...
function saveAhorro($db, $cuenta_id, $anio_ant, $mes_ant, $anio, $mes) {
    ...
    if($db->count == 0) {
        ...
        echo("<div style='color:red;'>Existe un registro - Cuenta_id: " . $resultados[0]['cuenta_id'] .
